...
const translations = {
  en: {
    ...
    'bento-text-1': 'I am a Software Engineering graduate with a minor in Decision Analytics from KFUPM.',
    'bento-text-2': 'My core interests lie in IT consulting, digital transformation, and Agentic AI. I am committed to leveraging emerging technologies to drive innovation.',
  ...
  ar: {
    ...
    'bento-text-1': 'أنا خريج هندسة برمجيات مع تخصص دقيق في تحليلات اتخاذ القرار من جامعة الملك فهد للبترول والمعادن (KFUPM).',
    'bento-text-2': 'تتركز اهتماماتي في الاستشارات التقنية، التحول الرقمي، والذكاء الاصطناعي الوكيلي (Agentic AI). ألتزم بتوظيف التقنيات الناشئة لدفع عجلة الابتكار.',
