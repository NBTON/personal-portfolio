...
const translations = {
  en: {
    ...
    'bento-text-1': 'I am a Software Engineering graduate from KFUPM with a minor in Decision Analytics—a combination that allows me to bridge the gap between technical execution and strategic decision-making.',
    'bento-text-2': 'My expertise centers on digital transformation and Agentic AI. I am driven by the challenge of transforming emerging technologies into powerful tools that drive real-world innovation and growth.',
    ...
    'quote': 'Harnessing emerging technologies to foster a culture of innovation and deliver solutions that exceed expectations.',
  ...
  ar: {
    ...
    'bento-text-1': 'أنا خريج هندسة برمجيات من جامعة الملك فهد للبترول والمعادن مع تخصص دقيق في تحليلات اتخاذ القرار؛ وهو مزيج يمكّنني من الموازنة بين التنفيذ التقني والرؤية الاستراتيجية.',
    'bento-text-2': 'تتمحور خبراتي حول التحول الرقمي والذكاء الاصطناعي الوكيلي (Agentic AI). يسحرني تحدي تحويل التقنيات الناشئة إلى أدوات ذكية تصنع فارقاً حقيقياً في عالم الابتكار.',
    ...
    'quote': 'تسخير التقنيات الناشئة لتعزيز ثقافة الابتكار وتقديم حلول تفوق التوقعات.',
    ...
    'section-work': 'Selected Work',
    'contact-heading': 'Let\'s build<br>something <span class="text-green">great</span>.',
    'contact-sub': 'هل لديك مشروع في بالك، سؤال، أو تريد فقط أن تسلّم؟',
    'ph-name': '\u0627\u0633\u0645\u0643',
    ...
    'contact-heading': 'لنُبدع ما لم<br><span class="text-green">يُبدع من قبل</span>.',
